...
class RefBoxParserStateV1(EventState):
    ...
    def __init__(self):
        ...
        self.semantic_map_path = '/home/dir/sim_ws/src/talos_sim/dir_state/talos_leipzig_behaviors/talos_leipzig_flexbe_states/src/talos_leipzig_flexbe_states/semantic_map/leipzig_map.yaml'
